...
def parse_args():
    ...
    parser.add_argument(
        ...
        #             * yellow brick road: paved road with bright yellow bricks and
        ...
        #               ["cement road", "red brick road", "yellow brick road", "soil", "lawn",
        #               "water", "curb", "others"], some words in this list like red brick road
